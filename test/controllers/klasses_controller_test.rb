...
class KlassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create klass" do
    assert_difference("Klass.count") do
      post klasses_url, params: { klass: { letter: @klass.letter, number: @klass.number, students_count: @klass.students_count } }
    end
  ...
  test "should update klass" do
    patch klass_url(@klass), params: { klass: { letter: @klass.letter, number: @klass.number, students_count: @klass.students_count } }
